...
public class Login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String default_web_client_id = "817543920884-7s13b3gsde7ajnua3bk7ra4o84lu15lf.apps.googleusercontent.com";
        ...
        btn_login.setOnClickListener(v -> {
            ...
            btn_sign.setOnClickListener(w -> startActivity(new Intent(Login.this,Register.class )));
